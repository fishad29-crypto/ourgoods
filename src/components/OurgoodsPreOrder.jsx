      ...
      <div style={{
        ...
        <div style={{ 
          ...
          <div style={{ display: 'flex', flexDirection: 'column' }}>
            ...
            {/* Delivery text */}
            <div style={{ paddingLeft: '28px', fontSize: isMobile ? '7.5px' : '9px', letterSpacing: '-0.2px', whiteSpace: isMobile ? 'normal' : 'nowrap', color: 'rgba(255, 255, 255, 0.9)', marginTop: '2px', fontWeight: 600 }}>
