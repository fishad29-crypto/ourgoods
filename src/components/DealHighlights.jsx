    ...
    <div style={{ padding: '0 15px', marginBottom: '15px' }}>
      <div style={{
        ...
        <div style={{ 
          ...
          <div style={{ display: 'flex', flexDirection: 'column' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: '4px' }}>
                 <i className="las la-shopping-basket" style={{ color: '#fff', fontSize: '24px' }}></i>
                <span style={{ fontWeight: 900, fontSize: '16px', color: '#fff', letterSpacing: '-0.3px', whiteSpace: 'nowrap' }}>Bangladesh Market</span>
              </div>
            </div>
          ...
          <div 
            onClick={() => saveScrollAndNavigate(navigate, '/market/bangladesh-market')}
