            ...
            <div class="row mt-1">
                <div class="col-12">
                    <p class="m-0 py-1">
                        ...
                        <span class="fs-14 fw-600 text-dark">{{ $cart->quantity }}</span>
                    </p>
                </div>
                <div class="col-sm-12">
                ...
                <div class="col-sm-12">
                    <div class="fs-16 fw-600 text-dark">
                        <strong>
                            @php
                                $popupIsCombo = preg_match('/^combo_\d+/', $cart->variation ?? '');
                                $popupRaw = cart_product_price($cart, $product, false) * $cart->quantity;
                                $popupTotal = $popupIsCombo ? round($popupRaw) : $popupRaw;
                            @endphp
                            {{ single_price($popupTotal) }}
                        </strong>
                    </div>
                </div>
            </div>
