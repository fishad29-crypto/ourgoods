...
<div class="aiz-mobile-bottom-nav d-xl-none fixed-bottom border-top border-sm-bottom border-sm-left border-sm-right mx-auto mb-sm-2" style="background-color: rgb(255 255 255 / 90%)!important;">
    <div class="row align-items-center gutters-5">
        ...
        @endif
            ...
            <!-- Messages -->
            <div class="col">
                <a href="{{ route('conversations.index') }}" class="text-secondary d-block text-center pb-2 pt-3 {{ areActiveRoutes(['conversations.index'],'svg-active')}}">
                    <span class="d-inline-block position-relative px-2">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">
                            <path d="M14,0H2A2,2,0,0,0,0,2V11a2,2,0,0,0,2,2H4v3l4-3h6a2,2,0,0,0,2-2V2A2,2,0,0,0,14,0ZM3,5H13V6H3Zm7,4H3V8H10Zm3-5H3V3H13Z" fill="#91919b"/>
                        </svg>
                    </span>
                    <span class="d-block mt-1 fs-10 fw-600 text-reset {{ areActiveRoutes(['conversations.index'],'text-primary')}}">{{ translate('Messages') }}</span>
                </a>
            </div>
