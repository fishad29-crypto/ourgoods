@php
    ...
    $colorImagesMap = json_decode($detailedProduct->color_images ?? '{}', true) ?? [];
@endphp
<div id="product-gallery-wrapper" data-color-images='@json($colorImagesMap)'>
<div class="row">
            ...
            <div class="swiper thumb-slider w-100 h-100">
                <div class="swiper-wrapper">
                    ...
                    @foreach ($photos as $key => $photo)
                        <div class="swiper-slide rounded-corner-8px border border-light-gray bg-light cursor-pointer overflow-hidden d-flex align-items-center justify-content-center" data-photo-id="{{ trim($photo) }}">
    ...
    <div class="col-md-10 col-lg-9 col-xl-10 pl-lg-0 order-1 order-md-2">
        <div class="swiper main-slider position-relative d-flex align-items-center justify-content-center">
            <div class="swiper-wrapper">
                ...
                <!--Single-->
                <div
                    class="swiper-slide rounded-corner-8px border  border-light-gray bg-light overflow-hidden lightbox-item" data-photo-id="{{ trim($photo) }}">
