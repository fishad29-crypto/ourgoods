...
<div class="aiz-card-box h-auto bg-white py-3 hov-scale-img">
    <div class="position-relative h-140px h-md-200px img-fit overflow-hidden">
        ...
        @php $comboTop = 0; if(discount_in_percentage($product) > 0) $comboTop += 25; if($product->wholesale_product) $comboTop += 25; @endphp
        <span class="absolute-top-left rounded rounded-4 fs-11 text-white fw-700 px-2 lh-1-8 ml-1 mt-1"
            style="background-color:#0080fe; @if($comboTop > 0) top:{{ $comboTop }}px; @endif">
            {{ translate('Combo') }}
        </span>
        @endif
