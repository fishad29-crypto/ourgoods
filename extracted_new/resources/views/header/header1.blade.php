        ...
        <div class="row">
            <div class="col-lg-6 col">
                <ul class="list-inline d-flex justify-content-between justify-content-lg-start mb-0">
                    ...
                    @if (get_setting('show_currency_switcher') == 'on')
                        <li class="list-inline-item dropdown ml-3 ml-lg-0 mr-0 currency-visibility" id="currency-change">
                            @php
                    ...
                    @if (get_setting('show_become_seller') == 'on' && get_setting('vendor_system_activation') == '1')
                        <li class="list-inline-item ml-auto d-lg-none">
                            ...
                            <div class="dropdown-menu dropdown-menu-right fs-12 p-0 mt-1">
            ...
            <div class="col-6 text-right d-none d-lg-block top-text-color-visibility"
                ...
                <ul class="list-inline mb-0 h-100 d-flex justify-content-end align-items-center">
                    @if (get_setting('vendor_system_activation') == '1' && get_setting('show_become_seller') == 'on')
