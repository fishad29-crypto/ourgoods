        ...
        <div class="row gutters-16">
            ...
            <div class="col-lg-6">
                <div class="row gutters-16">
                    <!-- Profit & Finance -->
                    <div class="col-sm-6">
                        <div class="dashboard-box overflow-hidden mb-2rem" style="height: 470px; background: linear-gradient(135deg, #1a1c2e 0%, #2d1b4e 50%, #1a3a4e 100%);">
                            <div class="d-flex flex-column justify-content-between h-100">
                                <!-- Total Revenue -->
                                <div>
                                    <div class="d-flex justify-content-between align-items-start">
                                        <div>
                                            <h1 class="fs-28 fw-700 text-white mb-0">
                                                {{ single_price($total_revenue) }}
                                            </h1>
                                            <h3 class="fs-12 fw-600 mb-0" style="color: #a8b3cf;">{{ translate('Total Revenue') }}</h3>
                                        </div>
                                        <div class="d-flex align-items-center justify-content-center" style="width:40px;height:40px;border-radius:12px;background:rgba(255,255,255,0.1);">
                                            <i class="las la-coins fs-22 text-white"></i>
                                        </div>
                                    </div>
                                    <div class="d-flex align-items-center mt-2">
                                        <span class="badge px-2 py-1 fs-11 fw-600" style="background:rgba(255,255,255,0.15);color:#fff;border-radius:6px;">
                                            <i class="las la-shopping-bag mr-1"></i>{{ number_format($total_products_sold) }} {{ translate('Products Sold') }}
                                        </span>
                                    </div>
                                </div>

                                <!-- Profit this month pill -->
                                <div class="d-flex align-items-center justify-content-between p-3 rounded-2 mr-2" style="background: linear-gradient(90deg, #00c853, #00e676);">
                                    <h3 class="fs-12 fw-600 mb-0 text-white">
                                        <i class="las la-calendar-check mr-1"></i>{{ translate('Profit This Month') }}
                                    </h3>
                                    <h3 class="fs-14 fw-700 mb-0 text-white">
                                        {{ single_price($profit_this_month) }}
                                    </h3>
                                </div>

                                <!-- Finance Stats -->
                                <div>
                                    <h3 class="fs-12 fw-600 mb-2" style="color: #a8b3cf;">
                                        <i class="las la-chart-pie mr-1"></i>{{ translate('Finance Overview') }}
                                    </h3>
                                    <canvas id="graph-3" class="w-100" height="110"></canvas>
                                </div>
                                ...
                                <div>
                                    ...
                                    <div class="d-flex justify-content-between mb-2 align-items-center">
                                        <h3 class="fs-12 fw-600 mb-0" style="color: #a8b3cf;">
                                            <span class="d-inline-block mr-2" style="width:8px;height:8px;border-radius:50%;background:#ff6b6b;"></span>
                                            {{ translate('Cost of Goods (COGS)') }}
                                        </h3>
                                        <h3 class="fs-13 fw-700 mb-0" style="color: #ff6b6b;">
                                            {{ single_price($total_cogs) }}
                                        </h3>
                                    </div>
                                    <!-- Total Profit -->
                                    <div class="d-flex justify-content-between mb-2 align-items-center">
                                        <h3 class="fs-12 fw-600 mb-0" style="color: #a8b3cf;">
                                            <span class="d-inline-block mr-2" style="width:8px;height:8px;border-radius:50%;background:#00e676;"></span>
                                            {{ translate('Total Profit') }}
                                        </h3>
                                        <h3 class="fs-13 fw-700 mb-0" style="color: {{ $total_profit >= 0 ? '#00e676' : '#ff6b6b' }};">
                                            {{ $total_profit >= 0 ? single_price($total_profit) : '-' . single_price(abs($total_profit)) }}
                                        </h3>
                                    </div>
                                    <!-- Sales this month -->
                                    <div class="d-flex justify-content-between align-items-center">
                                        <h3 class="fs-12 fw-600 mb-0" style="color: #a8b3cf;">
                                            <span class="d-inline-block mr-2" style="width:8px;height:8px;border-radius:50%;background:#448aff;"></span>
                                            {{ translate('Sales This Month') }}
                                        </h3>
                                        <h3 class="fs-13 fw-700 mb-0" style="color: #448aff;">
