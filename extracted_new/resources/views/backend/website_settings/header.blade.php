			...
			<div class="card">
				...
				<div class="card-body">
					<form action="{{ route('business_settings.update') }}" method="POST" enctype="multipart/form-data">
						...
						<div class="form-group row">
							<label class="col-md-3 col-from-label">{{translate('Show Become a Seller?')}}</label>
							<div class="col-md-8">
								<label class="aiz-switch aiz-switch-success mb-0">
									<input type="hidden" name="types[]" value="show_become_seller">
									<input type="checkbox" name="show_become_seller"
										@if(get_setting('show_become_seller') == 'on') checked @endif>
									<span></span>
								</label>
							</div>
						</div>
